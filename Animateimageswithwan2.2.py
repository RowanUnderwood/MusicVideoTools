...
VISION_SYSTEM_PROMPT = "Design a prompt for a video AI to animate this image in a believable way.  Describe a set of motions and emotions that fit into a 5 second shot.  Be sure to design the shot to include character motion if characters are present. Make sure the motion you describe fits the scene in a plausible way.  Provide the details and animation description ONLY as your response, no additional text, titles, or notes."
